...
global.reloadHandler = async function (restatConn) {
  ...
  conn.bye = '✦━━━━━━[ *GOOD BYE* ]━━━━━━✦\nSayonara *@user* 👋( ╹▽╹ )'
  conn.spromote = '@user Promoted As Admin!'
  conn.sdemote = '@user Demoted As admin!'
  conn.sDesc = 'Group Description Has Been Chnaged ! \n@desc'
  conn.sSubject = 'Group Subject Has Been Changed \n@subject'
  conn.sIcon = 'Group Icon Was Updated!'
  conn.sRevoke = 'Group Link Was Reseted \n@revoke'
